...
def run(is_training=True, render=False):
    ...
    while True:
        ...
        # Calculate average and std deviation of rewards for stability
    ...
    # Plot rewards, loss, and learning curve
    fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(12, 15))

    # Episode vs. Reward per Episode
    ...
    # Learning Curve: Episode vs. Mean Reward (Sliding Window)
